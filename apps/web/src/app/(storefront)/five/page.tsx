...
export default function PocFivePage() {
  const [openFaq, setOpenFaq] = useState<number | null>(0)
  const [mouse, setMouse] = useState({ x: -1000, y: -1000 })
  const [theme, setTheme] = useState<Theme>('editorial')
  const heroRef = useRef<HTMLDivElement>(null)

  // Cursor-following spotlight (only on hero)
  useEffect(() => {
  ...
  return (
    <div data-theme={theme} className="poc5-root font-[var(--font-inter)] text-[var(--ink)] bg-[var(--paper)] min-h-screen overflow-x-hidden transition-colors duration-500">
      <style>{`
        .poc5-root[data-theme="editorial"] {
          --paper: #F5F4F0;
          --paper-2: #EDEAE2;
          --ink: #0A0A0A;
          --ink-2: #2A2A2A;
      ...
      <header className="fixed top-4 left-4 right-4 z-40 flex items-center justify-between px-3 sm:px-5 py-2.5 bg-[var(--paper)]/85 backdrop-blur-xl border border-[var(--ink)]/10 rounded-full shadow-[0_8px_30px_-12px_rgba(10,10,10,0.18)] transition-colors duration-500">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            >
              <span className="flex gap-[3px]">
                ...
                <span className="w-2 h-2 rounded-full bg-[#1040b5]" />
                <span className="w-2 h-2 rounded-full bg-[#c8a422]" />
              </span>
          ...
          <button className="inline-flex items-center gap-1.5 bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--magenta)] hover:text-[var(--on-accent)] transition-colors duration-300 rounded-full px-4 py-2 text-sm font-medium cursor-pointer">
            ...
            <span>Cart</span>
            <span className="bg-[var(--paper)] text-[var(--ink)] rounded-full text-[10px] font-bold w-4 h-4 inline-flex items-center justify-center">0</span>
          </button>
        </div>
      </header>
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(420px circle at ${mouse.x}px ${mouse.y}px, rgba(229,5,113,0.10), transparent 60%)`,
          }}
          aria-hidden
        />
        ...
        <div className="relative mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 items-end">
          ...
          <div className="lg:col-span-7" data-reveal>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="#shop" className="group inline-flex items-center gap-2 bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--magenta)] hover:text-[var(--on-accent)] transition-colors duration-300 rounded-full pl-5 pr-2 py-2 text-sm font-medium cursor-pointer">
                Shop cartridges
                <span className="inline-flex items-center justify-center w-8 h-8 bg-[var(--paper)] text-[var(--ink)] rounded-full group-hover:rotate-45 transition-transform duration-300">
          ...
          <div className="lg:col-span-5 relative" data-reveal>
            <div className="relative">
              ...
              <div className="relative bg-[var(--ink)] text-[var(--paper)] rounded-[28px] p-6 sm:p-8 overflow-hidden">
                ...
                {/* "Cartridge" SVG mockup */}
                <div className="relative flex justify-center py-6">
                  <div className="animate-float relative">
                    <div className="w-40 h-56 sm:w-48 sm:h-64 rounded-[14px] bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#0A0A0A] shadow-[0_30px_60px_-20px_rgba(229,5,113,0.5)] relative overflow-hidden">
      ...
      {/* ─────────────── FOOTER ─────────────── */}
      <footer className="px-4 sm:px-8 lg:px-12 pt-8 pb-32">
        <div className="mx-auto max-w-7xl">
