    ...
    <div data-theme={theme} className="storefront font-[var(--font-inter)] text-[var(--ink)] bg-[var(--paper)] min-h-screen overflow-x-hidden transition-colors duration-500">
      ...
      <header className="fixed top-4 left-4 right-4 z-40 flex items-center justify-between px-3 sm:px-5 py-2.5 bg-[var(--paper)]/85 backdrop-blur-xl border border-[var(--ink)]/10 rounded-full shadow-[0_8px_30px_-12px_rgba(10,10,10,0.18)] transition-colors duration-500">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="inline-flex items-center gap-1.5 bg-[var(--magenta)] text-[var(--on-accent)] hover:opacity-90 transition-opacity duration-200 rounded-full px-4 py-2 text-sm font-medium cursor-pointer shadow-[0_4px_16px_-4px_rgba(229,5,113,0.55)]">
            ...
            <span>Cart</span>
            <span className="bg-white/25 text-white rounded-full text-[10px] font-bold w-4 h-4 inline-flex items-center justify-center">0</span>
          </button>
        </div>
      </header>
        ...
        <div className="relative mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 items-end">
          <div className="lg:col-span-7" data-reveal>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="#shop" className="group inline-flex items-center gap-2 bg-[var(--magenta)] text-[var(--on-accent)] hover:opacity-90 transition-opacity duration-200 rounded-full pl-6 pr-2 py-2.5 text-sm font-semibold cursor-pointer shadow-[0_8px_24px_-8px_rgba(229,5,113,0.6)]">
                Shop cartridges
